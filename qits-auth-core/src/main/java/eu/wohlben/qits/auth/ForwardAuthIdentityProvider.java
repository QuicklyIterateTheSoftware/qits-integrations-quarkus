 ...
 * entirely" literally true. No service makes a role decision on user traffic, so roles here would be
 * a security control that decides nothing.
 *
 * <p>Do not restore them to "match the monolith". A per-resource decision is a scoped machine token
 * and {@link MachineAuth}, not this class growing a header back. See migration-auth-plan.md §4.3.
 *
